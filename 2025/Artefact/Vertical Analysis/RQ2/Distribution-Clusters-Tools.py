...
plt.pie(Ratio, labels=my_labels, autopct='%1.1f%%', startangle=180, colors=my_colors,explode=my_explode,  textprops={'fontsize': 10},wedgeprops= {"edgecolor":"black", 'linewidth': 1.7})
